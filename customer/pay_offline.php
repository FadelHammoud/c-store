    ...
    <table class="table table-bordered table-hover table-striped"><!--  table table-bordered table-hover Begin  -->
        ...
        <thead><!--  thead Begin  -->
            ...
            <tr><!--  tr Begin  -->
                ...
                <th> Beirut, SJBL , Mobi Cash Details: </th>
        ...
        <tbody><!--  tbody Begin  -->
           ...
           <td> Bank Name: SJBL | Account No: 180-839-032 | Branch Name: Beirut | Branch Code: 1498 </td>
           <td> NIC #980-231-907 | Mobile No: 03-974-875 | Name: MrAbbass</td>
           <td> Real Name: Mr AbbassKrayyem | Mobile No: 71-564-478 Country: Lebanon| Name: MrAbbass | NIC #980-231-907 </td>
