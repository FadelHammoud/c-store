       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="../index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/Tech-Shop-logo.png" alt="Tech Shop" class="hidden-xs">
                   <img src="images/Tech-Shop-logo.png" alt="Tech Shop" class="visible-xs">
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <form action="confirm.php?update_id=<?php echo $order_id;  ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> Select Payment Operater: </label>
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> EXPIRY.DATE</label>
                          ...
                          <input type="text" class="form-control" placeholder="month/year" name="expiry_date" required>
                   ...
                   <?php 
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        $insert_payment = "insert into payments (amount,payment_mode,ref_no,code,payment_date) values ('$amount','$payment_mode','$ref_no','$code','$payment_date')";
